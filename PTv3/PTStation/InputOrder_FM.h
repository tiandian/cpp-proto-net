...
public:
	...
	int VolumeTotalOriginal(){ return m_innerOrderItem.Volume; }
	///有效期类型: 当日有效
	...
	CUstpFtdcInputOrderField& InnerOrder(){ return m_innerOrderItem; }
...
private:
	...
	CUstpFtdcInputOrderField m_innerOrderItem;
};
