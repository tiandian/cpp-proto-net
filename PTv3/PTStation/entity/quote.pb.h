...
class Quote : public ::google::protobuf::Message {
 public:
  ...
  inline void set_allocated_trading_day(::std::string* trading_day);
  ...
  inline void set_allocated_exchange_id(::std::string* exchange_id);
  ...
  inline void set_allocated_exchange_symbol_id(::std::string* exchange_symbol_id);
  ...
  // @@protoc_insertion_point(class_scope:entity.Quote)
 private:
...
inline void Quote::set_allocated_symbol(::std::string* symbol) {
  if (symbol_ != &::google::protobuf::internal::kEmptyString) {
    delete symbol_;
  }
  if (symbol) {
...
inline void Quote::set_allocated_trading_day(::std::string* trading_day) {
  if (trading_day_ != &::google::protobuf::internal::kEmptyString) {
    delete trading_day_;
  }
  if (trading_day) {
...
inline void Quote::set_allocated_exchange_id(::std::string* exchange_id) {
  if (exchange_id_ != &::google::protobuf::internal::kEmptyString) {
    delete exchange_id_;
  }
  if (exchange_id) {
...
inline void Quote::set_allocated_exchange_symbol_id(::std::string* exchange_symbol_id) {
  if (exchange_symbol_id_ != &::google::protobuf::internal::kEmptyString) {
    delete exchange_symbol_id_;
  }
  if (exchange_symbol_id) {
    set_has_exchange_symbol_id();
    exchange_symbol_id_ = exchange_symbol_id;
  } else {
    clear_has_exchange_symbol_id();
    exchange_symbol_id_ = const_cast< ::std::string*>(&::google::protobuf::internal::kEmptyString);
  }
...
inline void Quote::set_allocated_update_time(::std::string* update_time) {
  if (update_time_ != &::google::protobuf::internal::kEmptyString) {
    delete update_time_;
  }
  if (update_time) {
